...
void filter::accept_key(bool invite_key, const xtea_key& key)
{
    if(invite_key)
    {
        xtea_key::insert_key(invite_keys, key, true);
    }
    else
    {
        xtea_key::insert_key(keys, key, true);
    }
}


void filter::reject_key(bool invite_key, const xtea_key& key)
{
    if(invite_key)
    {
        xtea_key::delete_key(invite_keys, key);
    }
    else
    {
        xtea_key::delete_key(keys, key);
    }
}
