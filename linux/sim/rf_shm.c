...
UInt16 * rf_xmtr_ptr = NULL;        //!< did of device that actually xmted pkt
...
int init_shm(void)
{
    ...
    rf_xmtr_ptr = (UInt16 *)(data_rate_ptr + sizeof(UInt8));
    rf_channel_ptr = (UInt8 *)rf_xmtr_ptr + sizeof(UInt16);
