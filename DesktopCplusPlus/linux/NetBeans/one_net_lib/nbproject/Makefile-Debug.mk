...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-Debug.mk dist/Debug/GNU-Linux-x86/libone_net_lib.a

dist/Debug/GNU-Linux-x86/libone_net_lib.a: ${OBJECTFILES}
	${MKDIR} -p dist/Debug/GNU-Linux-x86
	${RM} dist/Debug/GNU-Linux-x86/libone_net_lib.a
	${AR} -rv ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libone_net_lib.a ${OBJECTFILES} 
	$(RANLIB) dist/Debug/GNU-Linux-x86/libone_net_lib.a
