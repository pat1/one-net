...
const UInt8 DEFAULT_INVITE_KEY[] = { 'c', 'c', '4', '3',   'z', '3', '8', '3',
                                   'c', 'c', '4', '3',   'z', '3', '8', '3'};
//const UInt8 DEFAULT_INVITE_KEY[] = { 'c', 'c', '4', '3',   'z', '3', '8', '4',
//                                     'c', 'c', '4', '3',   'z', '3', '8', '4'};
...
oncli_status_t oncli_set_user_pin_type(UInt8 PIN, UInt8 PIN_TYPE)
{
    ...
    switch(PIN)
    {
        case 0:
        {
            ...
            {
                USER_PIN0_REN = 0;
                USER_PIN0_OUT = user_pin[0].old_state;
            }
            break;
        } // pin 1 case //
        ...
        case 1:
        {
            ...
            {
                USER_PIN1_REN = 0;
                USER_PIN1_OUT = user_pin[1].old_state;
            }
            break;
        } // pin 2 case //
        ...
        case 2:
        {
            ...
            {
                USER_PIN2_REN = 0;
                USER_PIN2_OUT = user_pin[2].old_state;
            }
            break;
        } // pin 3 case //
        ...
        case 3:
        {
            ...
            {
                USER_PIN3_REN = 0;
                USER_PIN3_OUT = user_pin[3].old_state;
            }
            break;
        } // pin 4 case //
