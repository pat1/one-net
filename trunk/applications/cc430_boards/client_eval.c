...
static void client_check_user_pins(void)
{
    if(user_pin[0].pin_type == ONCLI_INPUT_PIN
      && USER_PIN0_IN != user_pin[0].old_state)
    {
        if(send_switch_command(USER_PIN0_IN ? ONA_ON : ONA_OFF, 0,
          ONE_NET_DEV_UNIT, 0))
        {
      ...
      && USER_PIN1_IN != user_pin[1].old_state)
    {
        if(send_switch_command(USER_PIN1_IN ? ONA_ON : ONA_OFF, 1,
          ONE_NET_DEV_UNIT, 0))
        {
      ...
      && USER_PIN2_IN != user_pin[2].old_state)
    {
        if(send_switch_command(USER_PIN2_IN ? ONA_ON : ONA_OFF, 2,
          ONE_NET_DEV_UNIT, 0))
        {
      ...
      && USER_PIN3_IN != user_pin[3].old_state)
    {
        if(send_switch_command(USER_PIN3_IN ? ONA_ON : ONA_OFF, 3,
          ONE_NET_DEV_UNIT, 0))
        {
